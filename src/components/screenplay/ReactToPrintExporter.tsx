  ...
  return (
    <div className="react-to-print-exporter">
      <button
        ...
        title={hasThaiContent ? 'Print/Export PDF with Thai support matching editor layout' : 'Print/Export PDF matching editor layout'}
      >
        {isPreparing ? (
      ...
      {isPreparing && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999]">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl text-center">
            ...
            <p className="text-[#1E4D3A] dark:text-white font-medium mb-2">กำลังเตรียม PDF...</p>
            <p className="text-[#577B92] dark:text-gray-400 text-sm">
              {hasThaiContent ? 'จัดรูปแบบตามที่เห็นในตัวแก้ไข + รองรับภาษาไทย' : 'Formatting to match editor layout'}
            </p>
          </div>
        </div>
      )}
